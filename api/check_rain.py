...
@app.route('/api/check_rain', methods=['POST'])
def check_rain():
    api_key = "31fb0963fbbfa9191b9426f24a5ae567"
    lat = request.form.get('lat', '19.025290')
    lon = request.form.get('lon', '72.853409')
...
# This is needed for Vercel to handle the function correctly
def handler(request):
